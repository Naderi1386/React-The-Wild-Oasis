...
function prepareData(startData:StartDataType[], stays:DataBookingSelectedType[]) {
...
interface DurationChartPropType {
  confirmedStays: DataBookingSelectedType[];
}
const DurationChart = ({ confirmedStays }: DurationChartPropType) => {
